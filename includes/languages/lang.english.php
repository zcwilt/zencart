...
$define = [
    ...
    'BOX_HEADING_GIFT_VOUCHER' => TEXT_GV_NAME . ' Account',
    'GV_FAQ' => TEXT_GV_NAME . ' FAQ',
    'ERROR_REDEEMED_AMOUNT' => 'Congratulations, you have redeemed ',
    'ERROR_NO_REDEEM_CODE' => 'You did not enter a ' . TEXT_GV_REDEEM . '.',
    'ERROR_NO_INVALID_REDEEM_GV' => 'Invalid ' . TEXT_GV_NAME . ' ' . TEXT_GV_REDEEM,
    'TABLE_HEADING_CREDIT' => 'Credits Available',
    'TEXT_SEND_OR_SPEND' => 'You have a balance available in your ' . TEXT_GV_NAME . ' account. You may spend it or send it to someone else. To send click the button below.',
    'TEXT_BALANCE_IS' => 'Your ' . TEXT_GV_NAME . ' balance is: ',
    'TEXT_AVAILABLE_BALANCE' => 'Your ' . TEXT_GV_NAME . ' Account',
    ...
    'TEXT_PRIVACY_CONDITIONS_DESCRIPTION' => 'Please acknowledge you agree with our privacy statement by ticking the following box. The privacy statement can be read <a href="' . zen_href_link . FILENAME_PRIVACY . '' . 'SSL' . '"><span class="pseudolink">here</span></a>.',
