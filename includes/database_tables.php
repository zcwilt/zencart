...
define('TABLE_BASKETS', DB_PREFIX . 'baskets');
define('TABLE_BASKET_PRODUCTS', DB_PREFIX . 'basket_products');
define('TABLE_BASKET_ATTRIBUTES', DB_PREFIX . 'basket_attributes');
