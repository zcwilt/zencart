...
/** @see zen_cfg_pull_down_zone_list() */
class PullDownZoneListRenderer implements ConfigFieldRendererInterface
{
    public function render(string $value, string $fieldName, array $params = []): string
    {
        return zen_cfg_pull_down_zone_list($value, $fieldName);
    }
}
