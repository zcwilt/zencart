...
/** @see zen_cfg_pull_down_tax_classes() */
class PullDownTaxClassesRenderer implements ConfigFieldRendererInterface
{
    public function render(string $value, string $fieldName, array $params = []): string
    {
        return zen_cfg_pull_down_tax_classes($value, $fieldName);
    }
}
