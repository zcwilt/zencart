...
/** @see zen_cfg_pull_down_zone_classes() */
class PullDownZoneClassesRenderer implements ConfigFieldRendererInterface
{
    public function render(string $value, string $fieldName, array $params = []): string
    {
        return zen_cfg_pull_down_zone_classes($value, $fieldName);
    }
}
