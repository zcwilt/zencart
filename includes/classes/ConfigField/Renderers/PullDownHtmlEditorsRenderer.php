...
/** @see zen_cfg_pull_down_htmleditors() */
class PullDownHtmlEditorsRenderer implements ConfigFieldRendererInterface
{
    public function render(string $value, string $fieldName, array $params = []): string
    {
        return zen_cfg_pull_down_htmleditors($value, $fieldName);
    }
}
