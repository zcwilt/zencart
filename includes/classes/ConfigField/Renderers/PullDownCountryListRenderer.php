...
/** @see zen_cfg_pull_down_country_list() */
class PullDownCountryListRenderer implements ConfigFieldRendererInterface
{
    public function render(string $value, string $fieldName, array $params = []): string
    {
        return zen_cfg_pull_down_country_list($value, $fieldName);
    }
}
