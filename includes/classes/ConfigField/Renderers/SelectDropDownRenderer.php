...
/** @see zen_cfg_select_drop_down() */
class SelectDropDownRenderer implements ConfigFieldRendererInterface
{
    public function render(string $value, string $fieldName, array $params = []): string
    {
        return zen_cfg_select_drop_down($params['options'] ?? [], $value, $fieldName);
    }
}
