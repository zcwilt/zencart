...
/** @see zen_cfg_password_display() */
class PasswordDisplayFormatter implements ConfigFieldFormatterInterface, SensitiveConfigFieldInterface
{
    public function format(string $value, array $params = []): string
    {
        return zen_cfg_password_display($value);
    }
