...
class ZenAiAssistMcpServer
{
    ...
    private ZenAiAssistContentRegistry $contentRegistry;
    ...
    public function __construct(
        ...
        $this->contentRegistry = new ZenAiAssistContentRegistry(
            $this->paths->projectRoot(),
            $this->paths->pluginRoot(),
            $this->runtimeInspector
        );
        $this->guidance = $guidance ?? new ZenAiAssistGuidanceService($this->contentRegistry);
        $this->skills = $skills ?? new ZenAiAssistSkillService($this->contentRegistry);
