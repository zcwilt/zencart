...
$psr4Autoloader->addPrefix('Zencart\PluginSupport', DIR_FS_CATALOG . DIR_WS_ADMIN_CLASSES . 'PluginSupport');
$psr4Autoloader->addPrefix('Zencart\QueryBuilder', DIR_FS_CATALOG . DIR_WS_CLASSES);
$psr4Autoloader->addPrefix('Zencart\TableViewControllers', DIR_FS_CATALOG . DIR_WS_ADMIN_CLASSES . 'TableViewControllers');
$psr4Autoloader->addPrefix('Zencart\AdminExceptions', DIR_FS_CATALOG . DIR_WS_ADMIN_CLASSES . 'Exceptions');
