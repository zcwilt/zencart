...
use Zencart\AdminUi\Reports\StatsProductsViewedReport;

require 'includes/application_top.php';

$reportClass = ReportResolver::getInstance()->resolve('stats_products_viewed', StatsProductsViewedReport::class);
