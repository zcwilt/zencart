...
//    zen_redirect(zen_href_link(FILENAME_CUSTOMERS, 'cID=' . $_GET['cID'] . (isset($_GET['page']) ? '&page=' . $_GET['page'] : ''), 'NONSSL'));
                ...
                <td class="dataTableContent"><?php echo htmlspecialchars($customer['customers_lastname'], ENT_COMPAT, CHARSET, TRUE); ?></td>
                <td class="dataTableContent"><?php echo htmlspecialchars($customer['customers_firstname'], ENT_COMPAT, CHARSET, TRUE); ?></td>
                <td class="dataTableContent"><?php echo htmlspecialchars($customer['entry_company'], ENT_COMPAT, CHARSET, TRUE); ?></td>
                <?php
                // -----
